...
class World(object):
    ...
    def __init__(self, players, shuffle, doorShuffle, logic, mode, swords, difficulty, difficulty_adjustments,
        ...
        for player in range(1, players + 1):
            ...
            set_player_attr('bombbags', False)
...
class CollectionState(object):
    ...
    def can_use_bombs(self, player):
        return (not self.world.bombbags[player] or self.has('Bomb Upgrade (+10)', player))
    ...
    def to_file(self, filename):
        ...
        with open(filename, 'w') as outfile:
            ...
            for player in range(1, self.world.players + 1):
                ...
                outfile.write('Bombbags:                        %s\n' % ('Yes' if self.metadata['bombbags'][player] else 'No'))
            if self.doors:
                outfile.write('\n\nDoors:\n\n')
                outfile.write('\n'.join(
